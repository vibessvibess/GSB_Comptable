...
switch ($action) {
    case'afficherFrais' :
        ...
        $nomASelectionner = $idVisiteur;      //Par defaut
        $_SESSION['mois'] = $mois;
        $moisASelectionner=$mois;
    break;
    ...
    try
        ...
        // $pdo->majFraisForfaitHdd($idVisiteur, $mois , $idFrais,$libelle,$montant,$date);
            ...
            {// quand le comptable clique sur reporter le frais va sur le mois suivant
    ...
    $etat="CL";
    $lesMois = $pdo->getListeMoisValidation($idVisiteur,$etatRechercher);
    require 'vues/v_ChoixM.php'; 
